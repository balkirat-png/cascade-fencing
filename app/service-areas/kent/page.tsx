...
const benefits = [
  ...
  "Fast response time for Kent residents",
...
const faqs = [
  {
    ...
    answer: "Yes, we serve the entire city of Kent and all surrounding areas. From East Hill to the Valley, we provide professional fence installation and repair services throughout Kent.",
  },
  {
    question: "How quickly can you provide an estimate in Kent?",
    answer: "We typically provide free estimates within 24-48 hours for Kent residents. Call us at (253) 228-9101 or request an estimate online, and we'll schedule a convenient time to visit your property.",
  },
  {
    question: "What's the typical timeline for fence installation in Kent?",
    answer: "Most residential fence projects in Kent take 1-3 days depending on the size and complexity. We provide a clear timeline during your estimate and work efficiently to complete your project on schedule.",
  },
  {
    question: "Do you handle permits if required in Kent?",
    answer: "We're familiar with Kent's permit requirements and can guide you through the process. We'll help you understand what's needed and provide support with permit applications when necessary.",
  },
];
    ...
    <main className="min-h-screen">
      ...
      <section className="relative h-[600px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            Wood Fence Installation Kent WA
          </motion.h1>
          <motion.p
            initial={{ opacity: 0, y: 30 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            Professional fence contractor serving Kent with expert installation and repair services
          </motion.p>
          <motion.div
            initial={{ opacity: 0, y: 30 }}
            animate={{ opacity: 1, y: 0 }}
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <p className="text-lg text-gray-700 leading-relaxed">
              Cascade Fencing & Repair is proud to serve Kent homeowners with professional <strong>wood fence installation Kent WA</strong> services. As a trusted <strong>fence contractor Kent WA</strong>, we bring over 20 years of experience to every project. Based in nearby Sumner, we understand the unique needs of Kent properties, from the established neighborhoods of East Hill to the growing communities in the Valley.
            </p>
            <p className="text-lg text-gray-700 leading-relaxed mt-6">
              Whether you need <strong>fence installation Kent WA</strong> for a new cedar privacy fence, modern horizontal design, or <strong>wood fence repair Kent WA</strong> for your existing fence, we deliver exceptional craftsmanship using premium materials. Our local, family-owned business provides personalized service and transparent pricing that Kent residents trust.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Comprehensive fence installation and repair services for Kent homeowners
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            >
              ...
              <p className="text-gray-600 mb-6 leading-relaxed">
                Professional installation of cedar privacy fences, horizontal fences, solid board fences, picture frame fences, hog wire fences, and custom designs. We provide free estimates, include removal of old fences, and use premium cedar materials built to last.
              </p>
              <Link
            ...
            >
              ...
              <p className="text-gray-600 mb-6 leading-relaxed">
                Expert fence repair services including post replacement, rail repairs, board replacement, leaning fence correction, gate repairs, and storm damage repairs. Fast response time and quality workmanship that extends the life of your fence.
              </p>
              <Link
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-lg text-gray-600">
              Trusted local fence contractor serving the Kent community
            </p>
          </motion.div>
      ...
      <section className="py-16 md:py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-lg text-gray-600">
              Fence styles Kent homeowners love
            </p>
          </motion.div>
      ...
      <section className="py-16 md:py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-lg text-gray-600">
              Quality craftsmanship serving Kent and surrounding communities
            </p>
          </motion.div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-lg text-gray-700 leading-relaxed mb-6">
              In addition to Kent, we proudly serve homeowners throughout Pierce County and South King County. Our local expertise and commitment to quality have made us the trusted choice for fence installation and repair across the region.
            </p>
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-serif font-bold text-white mb-6">
              Ready to Transform Your Kent Property?
            </h2>
            <p className="text-xl text-white/90 mb-8 leading-relaxed">
              Get your free estimate today. Expert fence installation and repair serving Kent with premium cedar materials and 20+ years of experience.
            </p>
